import json, math, heapq, numpy as np, rasterio
...
latc=math.radians(59.963); k=math.cos(latc)
...
# --- DEM
with rasterio.open('data/dtm_utm33_5m.tif') as ds:
...
np.savez_compressed('data/terrain.npz',elev=elev,slope=slope,aspect=aspect,hli=hli,tpi100=tpi100,tpi300=tpi300,twi=twi,acc=acc,XX=XX,YY=YY,UX=UX,UY=UY)
